...
void LocalPoseSensorClient_ReceiveFSM::setupIopConfiguration()
{
    ...
    this->set_rate(p_hz);
    this->set_supported_service(*this, "urn:jaus:jss:mobility:LocalPoseSensor", 1, 1);
...
void LocalPoseSensorClient_ReceiveFSM::handleReportLocalPoseExtAction(ReportLocalPoseExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
}
