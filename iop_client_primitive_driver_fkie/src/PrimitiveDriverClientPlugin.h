...
#ifndef PRIMITIVEDRIVERCLIENTPLUGIN_H
#define PRIMITIVEDRIVERCLIENTPLUGIN_H

#include "urn_jaus_jss_mobility_PrimitiveDriverClient/PrimitiveDriverClientService.h"
...
class DllExport PrimitiveDriverClientPlugin : public PluginInterface
{
public:
	PrimitiveDriverClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_PrimitiveDriverClient::PrimitiveDriverClientService *p_my_service;
