...
public:
    ...
    virtual void handleReportGlobalWaypointExtAction(ReportGlobalWaypointExt msg, Receive::Body::ReceiveRec transportData);
    virtual void handleReportTravelSpeedAction(ReportTravelSpeed msg, Receive::Body::ReceiveRec transportData);
    virtual void handleReportTravelSpeedExtAction(ReportTravelSpeedExt msg, Receive::Body::ReceiveRec transportData);
