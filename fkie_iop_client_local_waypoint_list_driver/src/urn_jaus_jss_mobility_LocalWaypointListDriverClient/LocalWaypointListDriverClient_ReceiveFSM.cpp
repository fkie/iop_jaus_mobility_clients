...
void LocalWaypointListDriverClient_ReceiveFSM::handleReportLocalWaypointAction(ReportLocalWaypoint msg, Receive::Body::ReceiveRec transportData)
{
    ...
    RCLCPP_DEBUG(logger, "localWaypointListAction from %s - x: %.2f, y: %.2f, z: %.2f", sender.str().c_str(), x, y, z);
...
void LocalWaypointListDriverClient_ReceiveFSM::handleReportLocalWaypointExtAction(ReportLocalWaypointExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "handleReportLocalWaypointExtAction not implemented");
}
...
void LocalWaypointListDriverClient_ReceiveFSM::handleReportTravelSpeedExtAction(ReportTravelSpeedExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
