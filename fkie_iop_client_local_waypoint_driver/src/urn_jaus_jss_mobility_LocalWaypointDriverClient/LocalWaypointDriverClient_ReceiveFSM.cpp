...
void LocalWaypointDriverClient_ReceiveFSM::handleReportLocalWaypointExtAction(ReportLocalWaypointExt msg, Receive::Body::ReceiveRec transportData)
{
...
void LocalWaypointDriverClient_ReceiveFSM::handleReportTravelSpeedExtAction(ReportTravelSpeedExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
