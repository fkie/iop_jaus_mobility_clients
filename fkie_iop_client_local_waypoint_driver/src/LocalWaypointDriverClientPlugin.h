...
#ifndef LOCALWAYPOINTDRIVERCLIENTPLUGIN_H
#define LOCALWAYPOINTDRIVERCLIENTPLUGIN_H

#include "urn_jaus_jss_mobility_LocalWaypointDriverClient/LocalWaypointDriverClientService.h"
...
class DllExport LocalWaypointDriverClientPlugin : public PluginInterface
{
public:
	LocalWaypointDriverClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_LocalWaypointDriverClient::LocalWaypointDriverClientService *p_my_service;
