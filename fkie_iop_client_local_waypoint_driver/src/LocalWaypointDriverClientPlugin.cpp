...
#include "LocalWaypointDriverClientPlugin.h"

using namespace iop;
using namespace urn_jaus_jss_mobility_LocalWaypointDriverClient;
...
LocalWaypointDriverClientPlugin::LocalWaypointDriverClientPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* LocalWaypointDriverClientPlugin::get_service()
{
	return p_my_service;
}

void LocalWaypointDriverClientPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new LocalWaypointDriverClientService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::LocalWaypointDriverClientPlugin, iop::PluginInterface)
