...
#ifndef GLOBALWAYPOINTDRIVERCLIENTPLUGIN_H
#define GLOBALWAYPOINTDRIVERCLIENTPLUGIN_H

#include "urn_jaus_jss_mobility_GlobalWaypointDriverClient/GlobalWaypointDriverClientService.h"
...
class DllExport GlobalWaypointDriverClientPlugin : public PluginInterface
{
public:
	GlobalWaypointDriverClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_GlobalWaypointDriverClient::GlobalWaypointDriverClientService *p_my_service;
