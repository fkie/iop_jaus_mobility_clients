...
#include "GlobalWaypointDriverClientPlugin.h"

using namespace iop;
using namespace urn_jaus_jss_mobility_GlobalWaypointDriverClient;
...
GlobalWaypointDriverClientPlugin::GlobalWaypointDriverClientPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* GlobalWaypointDriverClientPlugin::get_service()
{
	return p_my_service;
}

void GlobalWaypointDriverClientPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new GlobalWaypointDriverClientService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::GlobalWaypointDriverClientPlugin, iop::PluginInterface)
