...
void GlobalPoseSensorClient_ReceiveFSM::handleReportGeomagneticPropertyAction(ReportGeomagneticProperty msg, Receive::Body::ReceiveRec transportData)
{
    ...
    RCLCPP_WARN(logger, "handleReportGeomagneticPropertyAction not implemented");
}
...
void GlobalPoseSensorClient_ReceiveFSM::handleReportGlobalPoseExtAction(ReportGlobalPoseExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "handleReportGlobalPoseExtAction not implemented");
}
