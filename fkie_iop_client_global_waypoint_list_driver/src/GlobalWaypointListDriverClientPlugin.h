...
#ifndef GLOBALWAYPOINTLISTDRIVERCLIENTPLUGIN_H
#define GLOBALWAYPOINTLISTDRIVERCLIENTPLUGIN_H

#include "urn_jaus_jss_mobility_GlobalWaypointListDriverClient/GlobalWaypointListDriverClientService.h"
...
class DllExport GlobalWaypointListDriverClientPlugin : public PluginInterface
{
public:
	GlobalWaypointListDriverClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_GlobalWaypointListDriverClient::GlobalWaypointListDriverClientService *p_my_service;
